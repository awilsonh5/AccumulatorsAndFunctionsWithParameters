...
def run_test_draw_circles():
    ...
    # ------------------------------------------------------------------
    # Students:
    #   Do NOT touch this function - it has no DONE (ha) in it.
    # ------------------------------------------------------------------
    print()
    print('--------------------------------------------------')
...
def run_test_even_better_draw_circles():
    even_better_draw_circles(30, 15, 'blue')
    even_better_draw_circles(100, 3, 'purple')
    even_better_draw_circles(200, 1, 'red')


def even_better_draw_circles(n, s, c):
    window = rg.RoseWindow(400, 400)

    center = rg.Point(200, 200)
    for k in range(n+1):
        circle = rg.Circle(center, s * k)
